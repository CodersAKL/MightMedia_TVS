...
class Fizl extends CI_Controller {
	...
	public function _remap()
	{
		...
		define('SITE_FOLDER', $this->load->get_var('site_folder'));
		...
		$template_path = FCPATH.$this->load->get_var('assets_folder').'/templates/';
	...
	private function embed($file, $attributes)
	{
		...
		$embed_content = read_file(FCPATH.$this->load->get_var('assets_folder').'/embeds/'.$file.'.html');
