<?php echo get_view_path( __FILE__ );?>
...
<p>If you are exploring CodeIgniter for the very first time, you should start by reading the <a href="docs/">User Guide</a>.</p>
