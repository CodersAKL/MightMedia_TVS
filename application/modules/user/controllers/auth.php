...
//		$this->load->view('user/login', $this->data);
	...
	function forgot_password()
	{
		...
		else
		{
			...
			if ( empty( $identity->{$this->config->item('identity', 'ion_auth')} ) ) {
				// There is no such username or email
				$this->session->set_flashdata('message', $this->ion_auth->errors());
		...
		if ($user)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						$this->session->set_flashdata('message', $this->ion_auth->errors());
						redirect('user/auth/reset_password/' . $code);
					}
				}
			}
		}
	...
	function create_user()
	{
		...
		else
		{
			...
			$this->load->view('user/create_user', $this->data);
		}
	}
	...
	function create_group()
	{
		...
		else
		{
			...
			$this->load->view('user/create_group', $this->data);
		}
	}
	...
	function edit_group($id)
	{
		...
		$this->load->view('user/edit_group', $this->data);
	}
